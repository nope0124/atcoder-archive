  ...
  Rep (i, 101) {
    Rep (j, 101) {
      Rep (k, 101) {
        ...
        dp[i][j][k] += (ld)(1 + dp[i - 1][j][k]) * (ld)(100 - i)/(100 - i + 100 - j + 100 - k);
        dp[i][j][k] += (ld)(1 + dp[i][j - 1][k]) * (ld)(100 - j)/(100 - i + 100 - j + 100 - k);
        dp[i][j][k] += (ld)(1 + dp[i][j][k - 1]) * (ld)(100 - k)/(100 - i + 100 - j + 100 - k);
      }
    }
  }
  cout <<fixed << setprecision(10)<< dp[100 - a][100 - b][100 - c] << endl;
}